...
class Penyakit extends CI_Controller {
	...
	public function index()
	{
		...
		$data['contentTitle'] = "Data Kerusakan / Solusi";
	...
	public function create(){
		...
		$data['contentTitle'] = "Data Kerusakan";
	...
	public function destroy($id){
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Penyakit berhasil di delete!</div>');
        redirect('admin/penyakit');
	}
}